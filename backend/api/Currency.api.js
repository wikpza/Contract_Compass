...
const repository = new Currency_repository_1.CurrencyRepository();
router.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { errors, input } = yield (0, requestValidator_1.RequestValidator)(Currency_dto_1.CreateCurrencyRequest, req.body);
        if (errors)
            return res.status(400).json({ message: "bad request", details: errors || {} });
        const result = yield repository.createCurrency(req.body);
...
router.patch("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { errors, input } = yield (0, requestValidator_1.RequestValidator)(Currency_dto_1.UpdateCurrencyRequest, req.body);
        if (errors)
            return res.status(400).json({ message: "bad request", details: errors || {} });
        ...
        const result = yield repository.updateCurrency({
            id,
            name: req.body.name,
...
router.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield repository.getCurrency({
            page: parsedPage,
            limit: parsedLimit,
...
router.delete("/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield repository.deleteCurrency({ id: id });
