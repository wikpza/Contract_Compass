...
const repository = new Company_repository_1.CompanyRepository();
router.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log(req.body);
        const { errors, input } = yield (0, requestValidator_1.RequestValidator)(Company_dto_1.CreateCompanyRequest, req.body);
        if (errors)
            return res.status(400).json({ message: "bad request", details: errors || {} });
        const result = yield repository.createCompany(req.body);
...
router.patch("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { errors, input } = yield (0, requestValidator_1.RequestValidator)(Company_dto_1.UpdateCompanyRequest, req.body);
        if (errors)
            return res.status(400).json({ message: "bad request", details: errors || {} });
        ...
        const result = yield repository.updateCompany(Object.assign(Object.assign({}, req.body), { id }));
        return res.status(201).json(result);
    }
    catch (error) {
        const err = error;
...
router.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield repository.getCompany({
            page: parsedPage,
            limit: parsedLimit,
...
router.delete("/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield repository.deleteCompany({ id: id });
