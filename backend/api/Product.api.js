...
router.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield repository.createProduct(req.body);
...
router.patch("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield repository.updateProduct(Object.assign(Object.assign({}, req.body), { id }));
        return res.status(201).json(result);
    }
    catch (error) {
        const err = error;
...
router.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield repository.getProduct({
            page: parsedPage,
            limit: parsedLimit,
...
router.delete("/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield repository.deleteProduct({ id: id });
