...
const repository = new Unit_repository_1.UnitRepository();
router.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { errors, input } = yield (0, requestValidator_1.RequestValidator)(Unit_dto_1.CreateUnitRequest, req.body);
        if (errors)
            return res.status(400).json({ message: "bad request", details: errors || {} });
        const result = yield repository.createUnit({
            name: req.body.name,
...
router.patch("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { errors, input } = yield (0, requestValidator_1.RequestValidator)(Unit_dto_1.UpdateUnitRequest, req.body);
        if (errors)
            return res.status(400).json({ message: "bad request", details: errors || {} });
        ...
        const result = yield repository.updateUnit({
            id,
            name: req.body.name,
            symbol: req.body.symbol
        });
...
router.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield repository.getUnit({
            page: parsedPage,
            limit: parsedLimit,
...
router.delete("/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield repository.deleteUnit({ id: id });
