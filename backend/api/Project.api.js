...
const repository = new Project_repository_1.ProjectRepository();
router.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log(req.body);
        const { errors, input } = yield (0, requestValidator_1.RequestValidator)(Project_dto_1.CreateProjectRequest, req.body);
        if (errors)
            return res.status(400).json({ message: "bad request", details: errors || {} });
        const result = yield repository.createProject(req.body);
...
router.patch("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { errors, input } = yield (0, requestValidator_1.RequestValidator)(Project_dto_1.UpdateProjectRequest, req.body);
        if (errors)
            return res.status(400).json({ message: "bad request", details: errors || {} });
        ...
        const result = yield repository.updateProject(Object.assign(Object.assign({}, req.body), { id }));
        return res.status(201).json(result);
    }
    catch (error) {
        const err = error;
...
router.patch("/status/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield repository.updateProjectStatus({ id });
        return res.status(201).json(result);
    }
    catch (error) {
        const err = error;
...
router.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield repository.getProject({
            page: parsedPage,
            limit: parsedLimit,
...
router.delete("/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield repository.deleteProject({ id: id });
...
router.get("/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield repository.getProjectDetail({ id: id });
