...
router.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { errors, input } = yield (0, requestValidator_1.RequestValidator)(Payment_dto_1.CreatePaymentRequest, req.body);
        if (errors)
            return res.status(400).json({ message: "bad request", details: errors || {} });
        const result = yield repository.createPayment(req.body);
...
router.post("/finish", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log(req.body);
        const { errors, input } = yield (0, requestValidator_1.RequestValidator)(Payment_dto_1.FinishPaymentRequest, req.body);
        if (errors)
            return res.status(400).json({ message: "bad request", details: errors || {} });
        const result = yield repository.finishPayment(req.body);
        return res.status(201).json(result);
    }
    catch (error) {
        const err = error;
...
router.patch("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield repository.cancelPayment({ id });
        return res.status(201).json(result);
    }
    catch (error) {
        const err = error;
...
router.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield repository.getPayment({
            page: parsedPage,
            limit: parsedLimit,
