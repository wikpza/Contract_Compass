...
const repository = new Inventory_repository_1.InventoryRepository();
router.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log(req.body);
        const { errors, input } = yield (0, requestValidator_1.RequestValidator)(Inventory_dto_1.AddProductContractRequest, req.body);
        if (errors)
            return res.status(400).json({ message: "bad request", details: errors || {} });
        const result = yield repository.addProductContract(req.body);
...
router.patch("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { errors, input } = yield (0, requestValidator_1.RequestValidator)(Inventory_dto_1.UpdateProductInventoryRequest, req.body);
        if (errors)
            return res.status(400).json({ message: "bad request", details: errors || {} });
        ...
        const result = yield repository.updateInventory(Object.assign(Object.assign({}, req.body), { id }));
        return res.status(201).json(result);
    }
    catch (error) {
        const err = error;
...
router.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield repository.getInventory({
            page: parsedPage,
            limit: parsedLimit,
...
router.get("/history/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const parsedSortType = sortType === "ASC" || sortType === "DESC" ? sortType : "ASC";
        const parsedSortBy = sortBy || "createdAt";
        const response = yield repository.getInventoryHistory({
            page: parsedPage,
            limit: parsedLimit,
            sortType: parsedSortType,
            sortBy: parsedSortBy,
...
router.delete("/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield repository.deleteInventory({ id: id });
...
router.post("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { errors, input } = yield (0, requestValidator_1.RequestValidator)(Inventory_dto_1.AddInventorySessionRequest, req.body);
        const id = parseInt(req.params.id);
        if (isNaN(id)) {
            return res.status(400).json({ message: "Invalid ID format",
                details: { id: ["Invalid ID format"] } });
        ...
        if (errors)
            return res.status(400).json({ message: "bad request", details: errors || {} });
        const result = yield repository.addInventoryProduct(Object.assign(Object.assign({}, req.body), { id }));
        return res.status(201).json(result);
    }
    catch (error) {
        const err = error;
