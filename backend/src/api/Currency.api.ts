...
import {CreateCurrencyRequest, UpdateCurrencyRequest} from "../dto/Currency.dto";
...
router.post("/",
    async (req:Request, res:Response):Promise<any>=>{
        try{
            ...
            const result = await repository.createCurrency(
                req.body
            )
...
router.get("/",
    async (req: Request, res: Response): Promise<any> => {
        try {
            ...
            const response = await repository.getCurrency({
                page: parsedPage,
                limit: parsedLimit,
...
router.delete("/:id",
    async (req:Request, res:Response, next:NextFunction):Promise<any>=>{
        try{
            ...
            const response = await repository.deleteCurrency({id:id})
